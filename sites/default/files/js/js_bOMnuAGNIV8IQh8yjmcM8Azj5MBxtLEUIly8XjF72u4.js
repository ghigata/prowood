...
(function ($) {
	$(document).ready(function() {
		...
		if ($('#block-views-listing-block_1 .view-content').length > 0)
			$('#block-views-listing-block_1 .view-content').before('<div id = "slide-nav"><a id = "prev" href = "#" title = "Preview">Prev</a><a id = "next" href = "#" title = "Next">Next</a></div>').cycle({
				fx: 'scrollHorz', 
